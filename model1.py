# -*- coding: utf-8 -*-
"""
Created on Tue Jul 23 15:49:10 2019
...
class CBOW_at1(nn.Module):
    def __init__(self,vocab_size,embed_size,window_size,output_size,batch,CUDA_type=False):
        ...
        self.liner1=nn.Linear(self.window_size*2*self.embed_size,self.output_size)
        self.liner2=nn.Linear(self.window_size*2*self.embed_size,self.output_size)
    ...
    def forward(self,input_x):
        ...
        #print(embed_x)
        em_x=embed_x.view(embed_x.shape[0],2,-1)
        #print(em_x)
        
        #print(em_x.shape)
        embed_x=em_x.sum(dim=1)
        #print(embed_x.shape)
        embed_x=embed_x.view(embed_x.shape[0],self.window_size*2*self.embed_size)
